...
export class AniManCdkStack extends cfn.Stack {
  ...
  private createLambdas(
    ...
    topics[RequiredTopic.VideoDownloaded].grantPublish(functions[LambdaHandler.ManualResendDownloadedNotifications]);
...
enum LambdaHandler {
  ...
  ManualResendDownloadedNotifications = 'manual-resend-downloaded-notifications',
}
